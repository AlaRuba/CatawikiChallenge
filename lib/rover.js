function Rover (x, y, orientation, board) {
  if (x < 0) {
    throw new Error("Rover: Invalid X passed. It must be positive") 
  }
  if (y < 0) {
    throw new Error("Rover: Invalid Y passed. It must be positive") 
  }
  if (!(x % 1 === 0)) {
    throw new Error("Rover: Invalid X passed. It must be integer") 
  }
  if (!(y % 1 === 0)) {
    throw new Error("Rover: Invalid Y passed. It must be integer") 
  }
  if (!(orientation == "N" || orientation == "W" || orientation == "E" || orientation == "S")) {
    throw new Error("Rover: Invalid orientation passed. It must be one of NWSE");
  } 
  ...
  if (x > this.board.getEdgeX()) {
    throw new Error("Rover: Invalid X passed. Past bounds of board") 
  }
  if (y > this.board.getEdgeY()) {
    throw new Error("Rover: Invalid Y passed. Past bounds of board") 
  }
}
